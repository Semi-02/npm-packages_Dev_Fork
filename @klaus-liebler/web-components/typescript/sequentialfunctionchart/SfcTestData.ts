...
export class SfcTestDataProvider {
  public static getBasicSfcData(): SfcData {
    ...
    // Erstelle SfcData-Objekt
    const sfcData = new SfcData(undefined, booleans);
    // Erstelle Steps mit den spezifizierten Aktionen
    const step1 = new SfcStep("step1", "Initial Step", sfcData);
    step1.actions.push(new ActionS("act1_1", "Set Red LED", "redLed"));
    step1.actions.push(new ActionN("act1_2", "Reset Yellow LED", "yellowLed"));
    
    const step2 = new SfcStep("step2", "Process Step", sfcData);
    ...
    const step3 = new SfcStep("step3", "Verification Step", sfcData);
    ...
    const step4 = new SfcStep("step4", "Output Step", sfcData);
    ...
    const step5 = new SfcStep("step5", "Final Step", sfcData);
  ...
  public static getTrafficLightSfcData(): SfcData {
    ...
    const sfcData = new SfcData(undefined, booleans);
    // Ampelzustände
    const redStep = new SfcStep("step1", "Rot Phase", sfcData);
    ...
    const redYellowStep = new SfcStep("step2", "Rot-Gelb Phase", sfcData);
    ...
    const greenStep = new SfcStep("step3", "Grün Phase", sfcData);
    ...
    const yellowStep = new SfcStep("step4", "Gelb Phase", sfcData);
